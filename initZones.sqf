...
if (worldName == "Chernarus") then
    {
    _posAntenas = [[3257.07,4525.83,0],[12616.3,4363.7,0],[8205.3,6715.89,0],[8190.33,9040.25,0],[4077.97,11660.5,0]];
    _blacklistPos = [8,12];
...
if (worldName == "Chernarus") then
    {
    carreteras setVariable ["airport",[[[4717.43,2595.79,13.0202],225,"MG"],[[4823.22,2500.04,0],130,"MG"],[[5168.1,2313.15,8.96879],165,"MG"],[[5150.54,2350.56,0],360,"Mort"],[[5139.27,2354.41,0],360,"Mort"],[[5140.92,2343.19,0],360,"Mort"],[[4818.93,2550.77,0],360,"Mort"],[[4695.46,2479.07,0],260,"Tank"],[[5107.64,2329.84,0],185,"Tank"],[[4955.2,2424.53,0],40,"Tank"]],true];

    carreteras setVariable ["airport_1",[[[11977.6,12664.1,0],245,"Tank"],[[12173.8,12624.3,0],20,"Tank"],[[12165.7,12627.9,0],20,"Tank"],[[12426,12537.3,0],90,"Tank"],[[12262.3,12581.7,0],180,"Mort"],[[12232.4,12595.5,0],180,"Mort"],[[12246.8,12588.7,0],180,"Mort"],[[12193.8,12598.7,13.454],235,"MG"]],true];

    carreteras setVariable ["airport_2",[[[4753.89,10333.3,0],360,"Mort"],[[4758.94,10326.1,0],360,"Mort"],[[4765.82,10332.5,0],360,"Mort"],[[4782.4,10250.9,18],200,"MG"],[[4895.67,9824.3,0],150,"Tank"],[[4715.2,10401.5,0],360,"Tank"],[[4604.62,10275.8,0],275,"Tank"]],true];
}
else
    {
    if (worldName == "Altis") then
...
blackListDest = if (worldName == "Chernarus") then
                    {
                    ["puesto_5","puesto","puesto_8","puesto_11"]
                    }
                else
                    {
